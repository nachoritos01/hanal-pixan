  ...
  readonly pibSteps = computed(() => [
    {
      ...
      description:
        "Masa de maíz, recado rojo, pollo/pavo, tomate, cebolla, epazote y hojas de plátano.",
    },
    {
      title: "2. Preparación",
      description:
        "Se sazona el guiso, se amasa y se forma el pib; se envuelve con hojas soasadas.",
    },
    {
      title: "3. Cocción en tierra",
      description:
        "Se hornea en pib (hornilla bajo tierra) cubierto con hojas y tierra; sabor ahumado único.",
    },
  ]);
  ...
  readonly offeringItems = computed<OfferingItem[]>(() => [
    {
      title: "Pib",
      description:
        "Protagonista de la mesa; masa y guiso envueltos en hoja de plátano.",
      delay: 0,
    },
    {
      title: "Atole",
