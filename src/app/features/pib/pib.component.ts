...
export class PibComponent {
  ...
  readonly massaIngredients = computed<Ingredient[]>(() => {
    ...
    return [
      {
        name: "Masa de maíz",
        amount: `${(2 * multiplier).toFixed(1)}`,
        unit: "kg",
        essential: true,
      },
      {
        name: "Manteca de cerdo",
        amount: `${(250 * multiplier).toFixed(0)}`,
        unit: "g",
        essential: true,
      },
      {
      ...
      {
        name: "Caldo de pollo",
        amount: `${(500 * multiplier).toFixed(0)}`,
        unit: "ml",
        essential: false,
      },
      {
        name: "Polvo de hornear",
        amount: `${(1 * multiplier).toFixed(1)}`,
        unit: "cdta",
        essential: false,
      },
    ];
  ...
  readonly fillingIngredients = computed<Ingredient[]>(() => {
    ...
    return [
      {
        name: "Pollo",
        amount: `${(1.5 * multiplier).toFixed(1)}`,
        unit: "kg",
        essential: true,
      },
      {
        name: "Recado rojo",
        amount: `${(100 * multiplier).toFixed(0)}`,
        unit: "g",
        essential: true,
      },
      {
        name: "Jitomate",
        amount: `${(4 * multiplier).toFixed(0)}`,
        unit: "pzas",
        essential: true,
      },
      {
        name: "Cebolla blanca",
        amount: `${(2 * multiplier).toFixed(0)}`,
        unit: "pzas",
        essential: true,
      },
      {
        name: "Epazote",
        amount: `${(1 * multiplier).toFixed(0)}`,
        unit: "manojo",
        essential: true,
      },
      {
        name: "Hojas de plátano",
        amount: `${(6 * multiplier).toFixed(0)}`,
        unit: "hojas",
        essential: true,
      },
  ...
  readonly recipeSteps = computed<RecipeStep[]>(() => [
    {
      title: "Preparar el recado",
      description:
        "Disuelve el recado rojo en un poco de caldo tibio hasta formar una pasta homogénea. Reserva.",
      duration: "10 min",
      tips: "Si no tienes recado rojo, puedes hacer uno casero con achiote, comino, orégano, pimienta y ajo.",
    },
    {
      title: "Cocinar el guiso",
      description:
        "En una olla grande, cocina el pollo cortado en piezas con cebolla, jitomate picado y el recado. Condimenta con sal, pimienta y epazote. Cocina hasta que el pollo esté tierno.",
      duration: "45 min",
    ...
    },
    {
      ...
      description:
        "Mezcla la masa de maíz con manteca derretida, sal y un poco de caldo del guiso. Amasa hasta obtener una consistencia suave y maleable.",
      duration: "15 min",
    ...
    },
    {
      title: "Armar el pib",
      description:
        "Extiende masa en el centro de una hoja de plátano soasada. Coloca el guiso encima y cubre con más masa. Envuelve bien con la hoja.",
      duration: "20 min",
    ...
    },
    {
      ...
      description:
        "Tradicional: entierra en brasas. Moderno: hornea a 180°C por 1.5-2 horas, cubriendo con papel aluminio.",
      duration: "1.5-2 hrs",
