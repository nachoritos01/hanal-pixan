  ...
  readonly selectedMemorialData = computed(() => {
    ...
    const memorialData: Record<string, any> = {
      'memory-1': {
        ...
        description: 'Los altares familiares representan la continuidad de la tradición maya, donde cada elemento tiene un significado profundo y sagrado.',
        details: [
      ...
      'memory-2': {
        title: 'Luz Eterna',
        description: 'Las velas encendidas simbolizan la luz que guía a las ánimas de regreso a casa, manteniendo viva la conexión entre mundos.',
        details: [
