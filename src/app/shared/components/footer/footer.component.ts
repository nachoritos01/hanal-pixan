...
export class FooterComponent {
  ...
  readonly externalLinks = computed<FooterLink[]>(() => [
    {
      label: "INAH Yucatán",
      href: "https://centroyucatan.inah.gob.mx/publico/index.php",
      isExternal: true,
    },
    {
      label: "Secretaría de Cultura Yucatán",
      href: "https://cultura.yucatan.gob.mx/",
      isExternal: true,
    },
    {
      label: "Gran Museo Maya",
      href: "https://www.granmuseodelmundomaya.com.mx/",
      isExternal: true,
    },
    {
      label: "Turismo Yucatán",
      href: "https://yucatan.travel/",
      isExternal: true,
    },
  ]);
}
